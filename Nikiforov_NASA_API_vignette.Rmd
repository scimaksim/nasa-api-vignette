...
As of `ras.integer(format(Sys.Date(), "%Y")`, NASA Exoplanet Archive's Planetary Systems Composite Parameters (PSCompPars) table lists `r length(exoplanetCount$pl_name)` confirmed and unconfirmed exoplanet observations. 
