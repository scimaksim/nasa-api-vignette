...
tempMassHisto <- ggplot(tempMassData, aes(x = log(pl_bmasse,10)))
tempMassHisto + geom_histogram() +
  labs(x = TeX(r'($log(M\oplus)$)'), y = "Count",
       title = "The logarithmic distribution of mass in known exoplanets") 
```
