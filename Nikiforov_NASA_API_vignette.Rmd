...
Of the known `r length(exoplanetCount$pl_name)` exoplanets, `r (discoveriesByMethod[10])/(length(exoplanetCount$pl_name))*100`% were observed transiting their host star. Another `r discoveriesByMethod[9]` exoplanets were observed indirectly via the radial velocity method, whereby the planet and its star orbit around a common center of gravity and prompt noticeable Doppler shifts in the stellar spectrum.  
...
datatable(listHabitablePlanets)
