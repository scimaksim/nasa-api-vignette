...
We can observe at least one more obvious trend from the data - that of the "giant planet–metallicity correlation" - whereby giant planets "tend to appear around metal-rich stars" [@geosciences9030105]. Conversely, "there is little or no dependence on metallicity for low-mass planets such as super-Earths" [@pub.1041145028]. In astronomy, "metals" are generally defined as "elements heavier than helium" and quantified as the logarithm of the ratio of iron to helium atoms relative to our Sun ($[Fe \slash H] = log_{10} [Fe \slash H]_{\star} - log_{10} [Fe \slash H]_{\odot}$) (@2008, @https://doi.org/10.1111/j.1945-5100.2011.01194.x). The Planetary Systems Composite Parameters (PSCompPars) table includes measurements for both iron abundance,[Fe/H], and general metal content, [M/H] (@https://doi.org/10.26133/nea13).
