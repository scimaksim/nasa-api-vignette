...
The `annualExoDiscoveries()` function retrieves the latest data from NASA's Exoplanet Archive. By default, the function targets the Planetary Systems Composite Parameters Table and excludes bodies which have had their planetary status "questioned in the published literature" (@https://doi.org/10.26133/nea13).  
...
Moreover, to avoid complex orbital mechanics, the function also excludes observations in which planets orbit more than one stars. However, for fun, we quantify such systems below.
