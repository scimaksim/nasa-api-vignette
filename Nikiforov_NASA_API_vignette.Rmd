...
Habitability zone distances and incident flux are calculated only for planets with a mass of $10 M \oplus$ or less. This is the hypothetical threshold for "planets composed substantially of volatiles" such as $H_{2}O$ and $N$$H_{3}$ [@pub.1058671435]. 
