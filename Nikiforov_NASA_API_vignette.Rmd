...
exoDataTest <- annualExoDiscoveries()
exoDataTest
...
testData <- hzFluxCalculator(exoDataTest)

listHabitablePlanets <- habitableExoFinder(testData, minTemp = 181, maxTemp = 279,
