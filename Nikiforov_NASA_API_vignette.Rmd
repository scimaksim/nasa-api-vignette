...
This vignette has made use of the [NASA Exoplanet Archive](https://exoplanetarchive.ipac.caltech.edu/docs/intro.html), which is operated by the California Institute of Technology, under contract with the National Aeronautics and Space Administration under the Exoplanet Exploration Program (@https://doi.org/10.26133/nea13).
...
The `annualExoDiscoveries()` function retrieves the latest exoplanet data from NASA's Exoplanet Archive. By default, the function excludes bodies which have had their planetary status "questioned in the published literature".   
